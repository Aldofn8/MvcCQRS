...
namespace MvcRedArbor.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        public CandidatesController(MvccrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Candidates != null ? 
                          ...
                          Problem("Entity set 'MvccrudContext.Candidates'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvccrudContext.Candidates'  is null.");
            }
            var candidate = await _context.Candidates.FindAsync(id);
            if (candidate != null)
            {
